/*
    Copy this, or copy the helper locally if you want to use it.
 */
...
SmartThingsBuildHelper.compile('device_handler', './src', './eero-device_handler.groovy')

// Supports multiple outputs so you can build all the components of your project at the same time, with shared libs
SmartThingsBuildHelper.compile('smartapp', './src', './eero-smartapp.groovy')